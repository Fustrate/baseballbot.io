 ...
 * @copiedFromGithubCommit 5c25a26608fbd9a1d0127c9a3653609aa4b63e86
 */
...
module.exports = {
  ...
  create(context) {
    ...
    /**
     * Return the last token among the consecutive tokens that have no exceed max line difference in
     * between, before the first token in the next member.
     * @param {Token} prevLastToken The last token in the previous member node.
     * @param {Token} nextFirstToken The first token in the next member node.
     * @param {number} maxLine The max number of allowed line difference between consecutive tokens.
    ...
    /**
     * Return the first token among the consecutive tokens that have no exceed max line difference
     * in between, after the last token in the previous member.
     * @param {Token} nextFirstToken The first token in the next member node.
     * @param {Token} prevLastToken The last token in the previous member node.
     * @param {number} maxLine The max number of allowed line difference between consecutive tokens.
