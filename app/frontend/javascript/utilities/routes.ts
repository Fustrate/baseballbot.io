...
export const authorizedAccountsPath = (options: RouteOptions = {}) =>
  buildRoute('/accounts/authorized(.:format)', { ...options });
...
export const newAccountPath = (options: RouteOptions = {}) => buildRoute('/accounts/new(.:format)', { ...options });
